...
export default function FileInputEntrenador({ 
  onChange, 
  initialPhotoUrl,
  error
}: FileInputEntrenadorProps) {
      ...
      {preview && (
        <div className="flex justify-center">
          <img 
            ...
            className="max-h-40 w-auto object-contain rounded-lg shadow-md border border-gray-200" 
          />
        </div>
      )}
