...
export default function EntrenadorInfoCard({ academiaId, entrenadorId }: EntrenadorInfoCardProps) {
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    <Label>Dni</Label>
                    <Input type="text" onChange={(e) => handleChange("dni", e.target.value)} value={formData.dni || ""} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Nombres</Label>
                    <Input type="text" onChange={(e) => handleChange("nombres", e.target.value)} value={formData.nombres || ""} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Apellidos</Label>
                    <Input type="text" onChange={(e) => handleChange("apellidos", e.target.value)} value={formData.apellidos || ""} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Email</Label>
                    <Input type="text" onChange={(e) => handleChange("email", e.target.value)} value={formData.email || ""} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Celular</Label>
                    <Input type="text" onChange={(e) => handleChange("telefono", e.target.value)} value={formData.telefono || ""} />
                  </div>

                  <div className="col-span-2">
                    <Label>Licencia</Label>
                    <Input type="text" onChange={(e) => handleChange("licencia", e.target.value)} value={formData.licencia || ""} />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <FileInputEntrenador onChange={(url) => handleChange("fotoUrl", url)} initialLogoUrl={formData.fotoUrl} />
                  </div>
                </div>
              </div>
            </div>
