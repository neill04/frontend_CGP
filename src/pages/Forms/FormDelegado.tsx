...
export default function FormDelegado() {
  ...
  const onSubmitForm = (data: DelegadoDTO) => {
    data;
          ...
          <div className="relative w-full max-w-[600px] rounded-3xl bg-white p-6 lg:p-8 shadow-2xl">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 ml-15">
                Revisa la información antes de confirmar el registro del delegado
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                {previewUrl && (
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <p className="mb-2 text-xs text-blue-600 font-medium">Foto del Delegado</p>
                    <div className="flex justify-center">
                      <img 
                        src={previewUrl} 
                        alt="Preview delegado" 
                        ...
                        <div className={`flex items-center justify-center w-full px-4 py-8 border-2 border-dashed rounded-lg hover:border-red-400 hover:bg-red-50 transition ${
                          ...
                          <div className="text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-600">
                              Click para subir foto del delegado
                            </p>
